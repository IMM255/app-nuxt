...
class="btn btn-outline-primary py-1 px-3 me-4"
      ...
      <div class="list-task row">
        <transiton-group name="tasks" tag="div" class="list-task row">
        <CardItem
      ...
      <form ref="form" @submit.prevent="appendArray">
        ...
        <div v-else class="add-card" >
          <div class="card mb-2">
            <div class="card-body d-flex flex-column p-0">
              ...
              <select id="category" v-model="tasks.category" class="form-select" aria-label="Default select example" required>
